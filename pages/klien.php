...
<div id="content"> <!-- Membuat kontainer untuk konten utama -->
    <p id="tombol-tambah-container"> <!-- Membuat kontainer untuk tombol tambah dan pencarian -->
        <a href="indexadmin.php?p=klien-input" class="tombol">Tambah Klien</a> <!-- Tombol untuk menambah klien -->
        ...
        ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="tombol-opsi-container"><a href="indexadmin.php?p=klien-edit&id=<?php echo $r_tampil_klien['idklien']; ?>" class="tombol">Edit</a></div> <!-- Tombol untuk mengedit klien -->
                        <div class="tombol-opsi-container"><a href="proses/klien-hapus.php?id=<?php echo $r_tampil_klien['idklien']; ?>" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a></div> <!-- Tombol untuk menghapus klien -->
                    </td>
                </tr>
        <?php $nomor++;
            }
